    ...
    <View style={styles.container}>
      ...
      <View style={styles.main_notification}>
        ...
        <Text style={styles.description}>
          안녕하세요 모두의 공구, 모구 입니다:D{'\n'}
          {'\n'}
          링크 입력시 링크와 다른 제춤의 이미지가 뜨는 오류가 수정되었습니다.
          오늘도 모구를 이용해주셔서 감사합니다.
        </Text>
      </View>
        ...
        <View style={styles.Notification_title}>
          ...
          <TouchableOpacity onPress={toggleDropdown} style={styles.button}>
            <Image
              ...
              source={
                expanded
                  ? require('../../assets/toggledown.png')
                  : require('../../assets/toggleup.png')
              }
            />
          </TouchableOpacity>
        </View>
        ...
        <Animated.View style={[styles.dropdown, { height: heightInterpolate }]}>
          {expanded && (
            <Text style={styles.text}>
              ...
              이웃 사람들의 이름과, 비둘기, 강아지, 토끼, 노새, 노루, 프랑시스
              잠, 라이너 마리아 릴케 이런 시인의 이름을 불러 봅니다.
            </Text>
          )}
        </Animated.View>
      </View>
